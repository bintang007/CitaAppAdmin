package com.cita.myapplicationadmin;
...
import com.cita.myapplicationadmin.ui.profile.ProfileFragment;
...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private static final String URL_UPLOAD_PHOTO = Server.URL + "admin/upload_photo_profile.php";
    private static final String URL_UPLOAD_COVER = Server.URL + "admin/upload_cover_profile.php";
    private static final String TAG = MainActivity.class.getSimpleName();
    private static final String TAG_ADMIN_ID = "admin_id";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_home, R.id.nav_nutrient, R.id.nav_profile, R.id.nav_child, R.id.nav_diagnoses)
    ...
    public static class NavigationDrawer extends AsyncTask<Integer, String, Void> {
        ...
        protected Void doInBackground(Integer... integers) {
            StringRequest stringRequest = new StringRequest(Request.Method.POST, Server.URL + "admin/read_profile.php",
