...
import com.cita.myapplicationadmin.ui.nutrient.NutrientFragmentDirections;
    ...
    public void onBindViewHolder(@NonNull final NutrientViewHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                NutrientFragmentDirections.ActionNavNutrientToNavShowNutrient actionNavNutrientToNavShowNutrient =
                        NutrientFragmentDirections.actionNavNutrientToNavShowNutrient();
                actionNavNutrientToNavShowNutrient.setNutrientId(nutrientArrayList.get(position).getNutrientId());
                Navigation.findNavController(view).navigate(actionNavNutrientToNavShowNutrient);
            }
        });
    }
